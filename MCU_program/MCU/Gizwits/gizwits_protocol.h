...
* @{
*/
#define PRODUCT_KEY "98d1d8aa85514c78a1b9d887c6111c9a"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "9d3706d361324f09834d1c6056c52a53"
...
* @{
*/
#define MODEL_BYTEOFFSET                    0
#define MODEL_BITOFFSET                     0
#define MODEL_LEN                           1
#define Alarm_BYTEOFFSET                    0
#define Alarm_BITOFFSET                     1
#define Alarm_LEN                           2
#define MQ_2_BYTEOFFSET                    1
#define MQ_2_BITOFFSET                     0
#define MQ_2_LEN                           1
#define MENCI_1_BYTEOFFSET                    1
#define MENCI_1_BITOFFSET                     1
#define MENCI_1_LEN                           1
#define flame_1_BYTEOFFSET                    1
#define flame_1_BITOFFSET                     2
#define flame_1_LEN                           1
#define MENCI_2_BYTEOFFSET                    1
#define MENCI_2_BITOFFSET                     3
#define MENCI_2_LEN                           1
